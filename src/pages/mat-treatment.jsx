...
const MatTreatmentPage = ({ data }) => (
  <Layout>
    <SeoPress
      ...
      uri={`${data.wpPage.uri}`}
    />
    <PageBuilder content={data.wpPage.pageBuilder} className="page-mat-treatment"/>
  </Layout>
);

export const query = graphql`
    query {
        wpPage(databaseId: {eq: 451}) {
            title
            uri
            seo {
                title
...
export default MatTreatmentPage;
