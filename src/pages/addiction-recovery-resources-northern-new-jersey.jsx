...
const AddictionResourcesPage = ({ data }) => (
  <Layout>
    <SeoPress
      seo={data.wpPage.seo}
      ...
      uri={`${data.wpPage.uri}`}
    />
    <PageBuilder content={data.wpPage.pageBuilder} className="page-addiction-recovery"/>
  </Layout>
);

export const query = graphql`
  query {
    wpPage(databaseId: {eq: 276 }) {
      title
      uri
      seo {
        title
...
export default AddictionResourcesPage;
